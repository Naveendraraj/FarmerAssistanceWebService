	...
	<div class="container">
		<div class="w3layouts_breadcrumbs_left">
			<ul>
				...
				<li><i class="fa fa-cogs" aria-hidden="true"></i>Selected Crops</li>
			</ul>
		</div>
...
<div class="welcome">
	<div class="container">
		<h3 class="agileits_w3layouts_head">Our <span>Selected</span> Crops</h3>
		...
		<div class="container-fluid" >
							...
							<div class="col-xs-12 col-sm-offset-1 col-sm-10">
								<form style="padding-top:10px;" method="post" enctype="multipart/form-data">
									...
									<div class="col-xs-12 col-sm-8 col-sm-offset-2 form-line" style="background-color:#fff;padding:50px;">
										<div class="form-group">
											...
											<input type="text" name="selectedcrop_id" class="form-control" id="" onkeypress="return isNumberKey(event)" placeholder="" required>
										</div>
										<div class="form-group">
											<label for="Contact">Crop Name</label>
											<input type="text" name="selectedcrop_cropname" id="cropname" class="form-control" id="" placeholder="" required>
										</div>
										
										<div class="form-group">
											<label for="Contact">Disease & Precaution</label>
											<input type="text" name="selectedcrop_disease" class="form-control" id="" placeholder="" required>
										</div>
										
										<div class="col-xs-12" style="text-align:center;">
									
										<input type="submit" name="selectedcrops_submit" value="Submit" class="btn btn-primary submit">
								...
								<?php
								include 'db.php';
								if(isset($_POST['selectedcrops_submit']))
								{
								$t1=$_POST['selectedcrop_id'];
								$t2=$_POST['selectedcrop_cropname'];
								$t3=$_POST['selectedcrop_disease'];
								$query=mysql_query("INSERT INTO selectedcrops_details(id_selectedcrop, cropname_selectedcrop, disease_selectedcrop) 
								VALUES ('$t1', '$t2', '$t3')");
								          if($query)
								          {
