	...
	<div class="container">
		<div class="w3layouts_breadcrumbs_left">
			<ul>
				...
				<li><i class="fa fa-cogs" aria-hidden="true"></i>Disease & Precaution</li>
			</ul>
		</div>
		<div class="w3layouts_breadcrumbs_right">
			<h2>Disease & Precaution</h2>
		</div>
		<div class="clearfix"> </div>
	</div>
</div>
...
<div class="welcome">
	<div class="container">
		<h3 class="agileits_w3layouts_head">Crop Report</h3>
											...
											<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for names.." title="Type in a name">
												...
												<table id="myTable">
													  <tr class="header">
														...
														<th style="width:20%;">Crop Id</th>
														<th style="width:20%;">Crop Name</th>
														<th style="width:20%;">Disease & Precaution Solution</th>
													  </tr>
													  <tr>
											        <?php
											  		include('db.php');
													$query = mysql_query("SELECT * FROM sendingcrops_details") or die(mysql_error());
													while ($row = mysql_fetch_array($query)) {
													
													?>

													<td><?php echo $row['id']; ?></td>
													<td><?php echo $row['id_sendingcrop']; ?></td>
													<td><?php echo $row['cropname_sendingcrop']; ?></td>
													<td><?php echo $row['disease_sendingcrop']; ?></td>
													</tr>
