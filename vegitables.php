	...
	<div class="container">
		<div class="w3layouts_breadcrumbs_left">
			<ul>
				...
				<li><i class="fa fa-cogs" aria-hidden="true"></i>Vegitables</li>
			</ul>
		</div>
...
<div class="welcome">
	<div class="container">
		<h3 class="agileits_w3layouts_head">Current <span> Vegitables </span> Cost</h3>
		<div class="w3_agile_image">
			<img src="images/1.png" alt=" " class="img-responsive" />
		</div>
		<p class="agile_para">Current Vegitables Cost are</p>
			...
			<div class="col-md-12 w3_agile_services_grid"> 
				<div class="col-xs-12 w3_agile_services_grid_left">
					...
					<?php
								...
								$cost = $row['marketcost_vegitable'];
								$name = $row['name_vegitable'];	
								$imag = $row['image'];
								$pra= $imag."";
								?>
