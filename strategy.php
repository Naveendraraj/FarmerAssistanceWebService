...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	title:{
		text: "Farmer Empowerment Through Agriculture Technology and Information"
	},
	axisY: {
		title: "Target"
	},
		...
		<div class="container">
			<div class="w3layouts_breadcrumbs_left">
				<ul>
					...
					<li><i class="fa fa-picture-o" aria-hidden="true"></i>Item Strategy</li>
				</ul>
			</div>
			<div class="clearfix"> </div>
		</div>
