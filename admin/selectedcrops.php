		...
		<div class="col-md-10 content">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 style="text-align:center;"><strong>Selected Crops</strong></h3>
                </div>
											...
											<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for names.." title="Type in a name">
												...
												<table id="myTable">
													  <tr class="header">
														...
														<th style="width:20%;">Selecetd Crop Name</th>
														
														<th style="width:20%;">Disease & Precaution</th>
														<th style="width:20%;">Delete</th>
													  </tr>
													 <tr>
												        <?php
												  		include('db.php');
														$query = mysql_query("SELECT * FROM selectedcrops_details") or die(mysql_error());
														while ($row = mysql_fetch_array($query)) {
														?>

														<td><?php echo $row['id_selectedcrop']; ?></td>
														<td><?php echo $row['cropname_selectedcrop']; ?></td>
														<td><?php echo $row['disease_selectedcrop']; ?></td>
											
										
                                                      <td><a href="selectedcrops_delete.php?id=<?php echo $row['id']; ?> "><br>
