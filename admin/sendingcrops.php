		...
		<div class="col-md-10 content">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 style="text-align:center;"><strong>Sending Crop</strong></h3>
                </div>
                <div class="panel-body">
				    <div class="col-xs-12" style="padding-bottom:20px;">
							<div class="col-xs-12 col-sm-offset-1 col-sm-10">
								<form style="padding-top:10px;" method="post">
									...
									<div class="col-xs-12 col-sm-8 col-sm-offset-2 form-line" style="background-color:#fff;padding:50px;">
										<div class="form-group">
											...
											<input type="numeric" name="sendingcrop_id" class="form-control" id="" onkeypress="return isNumberKey(event)" placeholder="" required>
										</div>
										<div class="form-group">
											<label for="number">Crop Name</label>
											<input type="text" name="sendingcrop_cropname" id="cropname" class="form-control" id="" placeholder="" required>
										</div>
										<div class="form-group">
											<label for="City">Disease & Precaution Solution</label>
											<textarea type="text" name="sendingcrop_disease" class="form-control" id="" placeholder="" required></textarea>
										</div>
										<div class="col-xs-12" style="text-align:center;">
										
										<input type="submit" class="btn btn-primary submit" name="sendingcrops_submit">
								...
								<?php
								include 'db.php';
								if(isset($_POST['sendingcrops_submit']))
								{
								$t1=$_POST['sendingcrop_id'];
								$t2=$_POST['sendingcrop_cropname'];
								$t3=$_POST['sendingcrop_disease'];

								$query=mysql_query("INSERT INTO sendingcrops_details(id_sendingcrop, cropname_sendingcrop, disease_sendingcrop) 
								VALUES ('$t1', '$t2', '$t3')");
								          if($query)
								          {
