								...
								<form style="padding-top:10px;" method="post" enctype="multipart/form-data">
									...
									<div class="col-xs-12 col-sm-8 col-sm-offset-2 form-line" style="background-color:#fff;padding:50px;">
										<div class="form-group">
											...
											<input type="text" name="grains_type" class="form-control" value="Grians" placeholder="" readonly>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="text" name="grains_name" class="form-control" id="itemname" placeholder="" required>
										</div>
										<div class="form-group">
											<label for="Contact">Market cost</label>
											<input type="numeric" name="grains_marketcost" onkeypress="return isNumberKey(event)" class="form-control" id="" placeholder="" required>
										</div>
										<div class="form-group">
											<label for="Contact">Fixed cost</label>
											<input type="numeric" name="grains_fixedcost" onkeypress="return isNumberKey(event)" class="form-control" id="" placeholder="" required>
										</div>
										<div class="col-xs-12" style="text-align:center;">
										
										<input type="submit" name="grains_submit" value="Submit" class="btn btn-primary submit">
								 ...
								 <?php
									include 'db.php';
									if(isset($_POST['grains_submit']))
									{
									$t1=$_POST['grains_type'];
									$t2=$_POST['grains_name'];
									$t3=$_POST['grains_marketcost'];
									$t4=$_POST['grains_fixedcost'];
									...
									$query=mysql_query("INSERT INTO grains_details(type_grains, name_grains, marketcost_grains, fixedcost_grains, image) 
