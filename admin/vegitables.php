								...
								<form style="padding-top:10px;" method="post" enctype="multipart/form-data">
									...
									<div class="col-xs-12 col-sm-8 col-sm-offset-2 form-line" style="background-color:#fff;padding:50px;">
										<div class="form-group">
											...
											<input type="text" name="vegitable_type" class="form-control" value="Vegitables" placeholder="" readonly>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="text" name="vegitable_name" class="form-control" id="itemname" placeholder="" required>
										</div>
										<div class="form-group">
											<label for="Contact">Market cost</label>
											<input type="numeric" name="vegitable_marketcost" onkeypress="return isNumberKey(event)" class="form-control" id="" placeholder="" required>
										</div>
										<div class="form-group">
											<label for="Contact">Fixed cost</label>
											<input type="numeric" name="vegitable_fixedcost" onkeypress="return isNumberKey(event)" class="form-control" id="" placeholder="" required>
										</div>
										<div class="col-xs-12" style="text-align:center;">
										
										<input type="submit" name="vegitable_submit" value="Submit" class="btn btn-primary submit">
								 ...
								 <?php
									include 'db.php';
									if(isset($_POST['vegitable_submit']))
									{
									$t1=$_POST['vegitable_type'];
									$t2=$_POST['vegitable_name'];
									$t3=$_POST['vegitable_marketcost'];
									$t4=$_POST['vegitable_fixedcost'];
									...
									$query=mysql_query("INSERT INTO vegitable_details(type_vegitable, name_vegitable, marketcost_vegitable, fixedcost_vegitable, image) 
									VALUES ('$t1', '$t2', '$t3', '$t4', '$path')");
									          if($query)
									          {
