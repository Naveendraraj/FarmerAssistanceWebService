		...
		<div class="col-md-10 content">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 style="text-align:center;"><strong>Non Advisable Crop</strong></h3>
                </div>
								...
								<form style="padding-top:10px;" method="post">
									...
									<div class="col-xs-12 col-sm-8 col-sm-offset-2 form-line" style="background-color:#fff;padding:50px;">
										<div class="form-group">
											<label for="number">Non Advisable Crop</label>
											<input type="text" name="nonadvisablecrop_name" class="form-control" id="cropname" placeholder="" required>
										</div>
										<div class="form-group">
											<label for="City">Month</label>
											<input type="month" name="nonadvisablecrop_month" class="form-control" id="" placeholder="" required>
										</div>
										<div class="col-xs-12" style="text-align:center;">
										
										<input type="submit" name="nonadvisablecrop_submit" class="btn btn-primary submit">
										<button type="reset" class="btn btn-danger submit">Close</button>
									</div>
									</div>
								</form>
								<?php
								include 'db.php';
								if(isset($_POST['nonadvisablecrop_submit']))
								{
								$t1=$_POST['nonadvisablecrop_name'];
								$t2=$_POST['nonadvisablecrop_month'];
								
								$query=mysql_query("INSERT INTO nonadvisablecrop_details(name_nonadvisablecrop, month_nonadvisablecrop) 
								VALUES ('$t1', '$t2')");
								          if($query)
								          {
