...
<html lang="en">
<head>
  <title>Disease And Precaution</title>
  <meta charset="utf-8">
		...
		<div class="col-md-10 content">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 style="text-align:center;"><strong>Disease & Precaution</strong></h3>
                </div>
                <div class="panel-body">
				    <div class="col-xs-12" style="padding-bottom:20px;">
							<div class="col-xs-12 col-sm-offset-1 col-sm-10">
								<form style="padding-top:10px;" method="post">
									...
									<div class="col-xs-12 col-sm-8 col-sm-offset-2 form-line" style="background-color:#fff;padding:50px;">
										<div class="form-group">
											<label for="number">Disease</label>
											<input type="text" name="precaution_disease" class="form-control" id="" placeholder="" required>
										</div>
										<div class="form-group">
											<label for="City">Precaution</label>
											<input type="text" name="precaution_precaution" class="form-control" id="" placeholder="" required>
										</div>
										<div class="col-xs-12" style="text-align:center;">
										
										<input type="submit" name="precaution_submit" value="Submit" class="btn btn-primary submit">
								...
								<?php
								include 'db.php';
								if(isset($_POST['precaution_submit']))
								{
								$t1=$_POST['precaution_disease'];
								$t2=$_POST['precaution_precaution'];
								
								$query=mysql_query("INSERT INTO precaution_details(disease_precaution, precaution_precaution) 
								VALUES ('$t1', '$t2')");
								          if($query)
								          {
							...
							<div class="col-xs-12" style="padding-top:10px;">
								<div class="col-xs-12 col-sm-offset-1 col-sm-10">
									<div class="row">
								        ...
								        <?php
								  		include('db.php');
										$query = mysql_query("SELECT * FROM precaution_details") or die(mysql_error());
										while ($row = mysql_fetch_array($query)) {
										?>

										<td><?php echo $row['id']; ?></td>
										<td><?php echo $row['disease_precaution']; ?></td>
										<td><?php echo $row['precaution_precaution']; ?></td>
										
										
                                                      <td><a href="precaution_delete.php?id=<?php echo $row['id']; ?> "><br>
