								...
								<form style="padding-top:10px;" method="post" enctype="multipart/form-data">
									...
									<div class="col-xs-12 col-sm-8 col-sm-offset-2 form-line" style="background-color:#fff;padding:50px;">
										<div class="form-group">
											...
											<input type="text" name="flowers_type" class="form-control" value="Flowers" placeholder="" readonly>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="text" name="flowers_name" class="form-control" id="itemname" placeholder="" required>
										</div>
										<div class="form-group">
											<label for="Contact">Market cost</label>
											<input type="numeric" name="flowers_marketcost" onkeypress="return isNumberKey(event)" class="form-control" id="" placeholder="" required>
										</div>
										<div class="form-group">
											<label for="Contact">Fixed cost</label>
											<input type="numeric" name="flowers_fixedcost" onkeypress="return isNumberKey(event)" class="form-control" id="" placeholder="" required>
										</div>
										<div class="col-xs-12" style="text-align:center;">
										
										<input type="submit" name="flowers_submit" value="Submit" class="btn btn-primary submit">
								 ...
								 <?php
									include 'db.php';
									if(isset($_POST['flowers_submit']))
									{
									$t1=$_POST['flowers_type'];
									$t2=$_POST['flowers_name'];
									$t3=$_POST['flowers_marketcost'];
									$t4=$_POST['flowers_fixedcost'];
									...
									$query=mysql_query("INSERT INTO flowers_details(type_flowers, name_flowers, marketcost_flowers, fixedcost_flowers, image) 
