		...
		<div class="container">
			<div class="w3_agileits_banner_main_grid">
				<div class="w3_agile_logo">
					<h1><a href="home.php"><span>G</span>erminate<i>Grow healthy products</i></a></h1>
				</div>
			...
			<div class="w3agile_footer_grids">
				<div class="col-md-3 agileinfo_footer_grid">
					<div class="agileits_w3layouts_footer_logo">
						<h2><a href="home.php"><span>G</span>erminate<i>Grow healthy products</i></a></h2>
					</div>
				</div>
				...
				<div class="col-md-2 agileinfo_footer_grid agileinfo_footer_grid1">
					...
					<ul class="w3layouts_footer_nav">
						...
						<li><a href="icons.php"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Web Icons</a></li>
						<li><a href="typography.php"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Typography</a></li>
