	...
	<div class="container">
		<div class="w3layouts_breadcrumbs_left">
			<ul>
				...
				<li><i class="fa fa-cogs" aria-hidden="true"></i>Market Rate</li>
			</ul>
		</div>
...
<div class="welcome">
	<div class="container">
		<h3 class="agileits_w3layouts_head">Market Rate</h3>
											...
											<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for names.." title="Type in a name">
												...
												<table id="myTable">
													  <tr class="header">
														...
														<th style="width:20%;">Crop Name</th>
														<th style="width:20%;">Market Rate</th>
													  </tr>
													   <tr>
											        <?php
											  		include('db.php');
													$query = mysql_query("SELECT * FROM vegitable_details") or die(mysql_error());
													while ($row = mysql_fetch_array($query)) {
													
													?>

													
													<td><?php echo $row['name_vegitable']; ?></td>
													<td><?php echo $row['marketcost_vegitable']; ?></td>
													...
													<td><?php echo $row['name_grains']; ?></td>
													<td><?php echo $row['marketcost_grains']; ?></td>
										            ...
										            <?php
											  		include('db.php');
													$query = mysql_query("SELECT * FROM flowers_details") or die(mysql_error());
													while ($row = mysql_fetch_array($query)) {
													
													?>

													
													<td><?php echo $row['name_flowers']; ?></td>
													<td><?php echo $row['marketcost_flowers']; ?></td>
